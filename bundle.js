...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".card-deck {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n\n.card-header {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: space-between;\n}\n\n.card {\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  background-color: white;\n  height: 200px;\n  width: 200px;\n  border-radius: 20px;\n  margin: 0 15px;\n  box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);\n  position: relative;\n}\n.card p {\n  margin-bottom: 0;\n}\n\n.large {\n  width: 430px;\n}\n\n.card-title {\n  text-align: center;\n}\n\n.card-content {\n  width: inherit;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 15px;\n}\n\n.card-content-left {\n  width: 215px;\n}\n.card-content-left i {\n  padding-top: 5px;\n  color: #f3621d;\n}\n.card-content-left p {\n  margin-top: 10px;\n}\n\n.card-divider {\n  width: 0;\n  height: 130px;\n  border-right: solid 2px lightgray;\n  position: absolute;\n  margin-top: 50px;\n}\n\n.card-content-right {\n  width: 215px;\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  align-items: center;\n}\n.card-content-right span {\n  margin-top: 10px;\n  margin-bottom: 10px;\n}\n.card-content-right span i {\n  margin-right: 5px;\n}\n\n.card-goals {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  height: 130px;\n  margin-left: 20px;\n  margin-right: 40px;\n}\n.card-goals span b {\n  font-size: large;\n}\n\n.chart-box-large {\n  height: 140px;\n  width: 400px;\n  padding-left: 10px;\n  padding-right: 10px;\n}\n\n.chart-box-small {\n  height: 140px;\n  width: 150px;\n  padding-top: 10px;\n}\n\naside {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  width: 370px;\n  overflow: hidden;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n}\naside h2 {\n  margin-bottom: 15px;\n}\n\n.profile-pic {\n  height: 300px;\n}\n\n.info-section {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: flex-start;\n}\n\ntable {\n  margin-left: 12px;\n  padding-right: 20px;\n}\n\n.contact-info {\n  display: flex;\n  flex-wrap: wrap;\n  overflow-wrap: normal;\n  margin: 4%;\n}\n\nbody,\nhtml {\n  font-family: \"Roboto\", sans-serif;\n  color: #333333;\n  display: flex;\n  height: 100%;\n  width: 100%;\n  margin: 0;\n}\n\nmain {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: space-between;\n  height: auto;\n  overflow: hidden;\n}\n\nnav {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 60px;\n  padding-right: 60px;\n  background-color: #f5f6fa;\n  height: 100px;\n}\nnav p {\n  margin: 0;\n}\n\nbutton {\n  cursor: pointer;\n}\n\nh2,\np {\n  text-align: center;\n}\n\np {\n  margin-bottom: 0;\n}\n\nh4 {\n  font-size: large;\n  margin-top: 35px;\n  margin-bottom: 35px;\n  margin-left: 60px;\n  color: white;\n}\n\n.dropdown-content {\n  margin-left: 16px;\n  text-align: center;\n  background-color: rgba(255, 255, 255, 0.2);\n  width: inherit;\n  position: fixed;\n  border-radius: 4px;\n  z-index: 1;\n  padding-left: 10px;\n  padding-right: 10px;\n}\n.dropdown-content button {\n  background: none;\n  border: none;\n  color: white;\n  font-weight: bold;\n  padding: 5px;\n}\n\n.dropdown-divider {\n  border-right: solid 2px white;\n}\n\n.activity-dropdown {\n  padding-left: 10px;\n}\n\n.nav-day-date {\n  border: solid 1px black;\n  padding: 10px 15px;\n  border-radius: 30px;\n}\n.nav-day-date h3 {\n  display: inline;\n}\n.nav-day-date p {\n  display: inline;\n  margin-left: 10px;\n}\n\n.logo-box {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  height: 100px;\n}\n\n.logo-png {\n  height: 45px;\n}\n\n.main-sections {\n  display: flex;\n  flex: 1;\n  color: black;\n  overflow: hidden;\n}\n\n.grid-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  grid-gap: 30px;\n}\n\n.activity {\n  width: 48%;\n  background-color: #CA2929;\n  padding-bottom: 40px;\n  overflow: scroll;\n}\n\n.hydration-sleep {\n  width: 28%;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: space-between;\n  flex: 1;\n}\n\n.hydration {\n  background-color: #2e7ba6;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: space-between;\n  flex: 1;\n}\n\n.sleep {\n  background-color: #462c61;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: space-between;\n  flex: 1;\n}\n\n.section-title-with-dropdown {\n  display: flex;\n}\n\n.date-toggle {\n  border: none;\n  padding: 9px 15px 8px 15px;\n  border-radius: 5px;\n  background-color: white;\n  background-color: rgba(255, 255, 255, 0.4);\n  color: white;\n  font-size: 16px;\n  margin-top: 28px;\n  margin-left: 15px;\n  align-self: start;\n}\n.date-toggle p {\n  margin: 0;\n  cursor: pointer;\n}\n.date-toggle i {\n  margin-left: 5px;\n}\n\n.add-data {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-end;\n  align-items: center;\n  color: white;\n  margin-right: 60px;\n  position: relative;\n}\n.add-data i {\n  margin-right: 5px;\n}\n.add-data span {\n  cursor: pointer;\n}\n\n.add-data-form {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  background-color: white;\n  width: 250px;\n  height: 350px;\n  margin-top: 330px;\n  position: fixed;\n  z-index: 1;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  color: black;\n  border-radius: 5px;\n}\n.add-data-form input {\n  display: block;\n  background-color: #f1f1f1;\n  border: solid 1px darkgray;\n  height: 20px;\n  margin-bottom: 10px;\n}\n.add-data-form label {\n  font-size: 14px;\n  font-weight: bold;\n  color: black;\n}\n.add-data-form p {\n  margin-top: 0px;\n  margin-bottom: 10px;\n}\n.add-data-form button {\n  background-color: rgba(4, 170, 109, 0.8);\n  font-weight: bold;\n  color: white;\n  margin-bottom: 30px;\n  border: none;\n  border-radius: 3px;\n  padding: 10px 20px 10px 20px;\n}\n.add-data-form button:hover {\n  background-color: #04aa6d;\n}\n.add-data-form i {\n  margin-top: 15px;\n  margin-left: 205px;\n  cursor: pointer;\n}\n\n.small-form {\n  height: 280px;\n  margin-top: 260px;\n}\n\n.hidden {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/css/_cards.scss","webpack://./src/css/_mixins.scss","webpack://./src/css/styles.scss","webpack://./src/css/_userProfile.scss"],"names":[],"mappings":"AAEA;ECAE,aAAA;EACA,mBAAA;EACA,uBDD6B;ECE7B,mBDFqC;AEEvC;;AFCA;ECJE,aAAA;EACA,mBDIwB;ECHxB,8BDG6B;ECF7B,0BDE4C;AEK9C;;AFFA;EACE,kBAAA;ECTA,aAAA;EACA,sBDSwB;ECRxB,2BDQgC;ECPhC,mBDO4C;EAC5C,uBAAA;EACA,aAAA;EACA,YAAA;EACA,mBAAA;EACA,cAAA;EACA,yCAAA;EACA,kBAAA;AEQF;AFPI;EACA,gBAAA;AESJ;;AFLA;EACE,YAAA;AEQF;;AFLA;EACE,kBAAA;AEQF;;AFLA;EACE,cAAA;EChCA,aAAA;EACA,mBDgCwB;EC/BxB,8BD+B6B;EC9B7B,mBD8B4C;EAC5C,gBAAA;AEWF;;AFRA;EACE,YAAA;AEWF;AFVI;EACA,gBAAA;EACA,cAAA;AEYJ;AFVI;EACA,gBAAA;AEYJ;;AFRA;EACE,QAAA;EACA,aAAA;EACA,iCAAA;EACA,kBAAA;EACA,gBAAA;AEWF;;AFRA;EACE,YAAA;EACA,kBAAA;EC1DA,aAAA;EACA,sBD0DwB;ECzDxB,6BDyDgC;ECxDhC,mBDwD8C;AEchD;AFbI;EACA,gBAAA;EACA,mBAAA;AEeJ;AFdM;EACA,iBAAA;AEgBN;;AFXA;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,aAAA;EACA,iBAAA;EACA,kBAAA;AEcF;AFbI;EACD,gBAAA;AEeH;;AFXA;EACE,aAAA;EACA,YAAA;EACA,kBAAA;EACA,mBAAA;AEcF;;AFXA;EACE,aAAA;EACA,YAAA;EACA,iBAAA;AEcF;;ACzGA;EFAE,aAAA;EACA,sBAAA;EACA,2BEDgC;EFEhC,mBEF4C;EAC5C,YAAA;EACA,gBAAA;EAIA,2CAAA;AD4GF;AC/GI;EACA,mBAAA;ADiHJ;;AC5GA;EACE,aAAA;AD+GF;;AC5GA;EFdE,aAAA;EACA,mBEcwB;EFbxB,8BEa6B;EFZ7B,uBEY4C;ADkH9C;;AC/GA;EACE,iBAAA;EACA,mBAAA;ADkHF;;AC/GA;EACE,aAAA;EACA,eAAA;EACA,qBAAA;EACA,UAAA;ADkHF;;AA3IA;;EAEE,iCAAA;EACA,cAAA;EACA,aAAA;EACA,YAAA;EACA,WAAA;EACA,SAAA;AA8IF;;AA3IA;EACE,WAAA;EDbA,aAAA;EACA,sBCawB;EDZxB,2BCYgC;EDXhC,0BCW4C;EAC5C,YAAA;EACA,gBAAA;AAiJF;;AA9IA;EDnBE,aAAA;EACA,mBCmBwB;EDlBxB,8BCkB6B;EDjB7B,mBCiB4C;EAC5C,kBAAA;EACA,mBAAA;EACA,yBAAA;EACA,aAAA;AAoJF;AAnJI;EACE,SAAA;AAqJN;;AAjJA;EACE,eAAA;AAoJF;;AAjJA;;EAEE,kBAAA;AAoJF;;AAjJA;EACE,gBAAA;AAoJF;;AAjJA;EACE,gBAAA;EACA,gBAAA;EACA,mBAAA;EACA,iBAAA;EACA,YAAA;AAoJF;;AAjJA;EACE,iBAAA;EACA,kBAAA;EACA,0CAAA;EACA,cAAA;EACA,eAAA;EACA,kBAAA;EACA,UAAA;EACA,kBAAA;EACA,mBAAA;AAoJF;AAnJI;EACE,gBAAA;EACA,YAAA;EACA,YAAA;EACA,iBAAA;EACA,YAAA;AAqJN;;AAjJA;EACE,6BAAA;AAoJF;;AAjJA;EACE,kBAAA;AAoJF;;AAjJA;EACE,uBAAA;EACA,kBAAA;EACA,mBAAA;AAoJF;AAnJI;EACA,eAAA;AAqJJ;AAnJI;EACA,eAAA;EACA,iBAAA;AAqJJ;;AAjJA;ED3FE,aAAA;EACA,mBC2FwB;ED1FxB,uBC0F6B;EDzF7B,mBCyFqC;EACrC,aAAA;AAuJF;;AApJA;EACE,YAAA;AAuJF;;AApJA;EACE,aAAA;EACA,OAAA;EACA,YAAA;EACA,gBAAA;AAuJF;;AApJA;ED3GE,aAAA;EACA,sBC2GwB;ED1GxB,uBC0GgC;EDzGhC,mBCyGwC;EACxC,cAAA;AA0JF;;AAvJA;EACE,UAAA;EACA,yBAAA;EACA,oBAAA;EACA,gBAAA;AA0JF;;AAvJA;EACE,UAAA;EDxHA,aAAA;EACA,sBCwHwB;EDvHxB,2BCuHgC;EDtHhC,0BCsH4C;EAC5C,OAAA;AA6JF;;AA1JA;EACE,yBAAA;ED9HA,aAAA;EACA,sBC8HwB;ED7HxB,2BC6HgC;ED5HhC,0BC4H4C;EAC5C,OAAA;AAgKF;;AA7JA;EACE,yBAAA;EDpIA,aAAA;EACA,sBCoIwB;EDnIxB,2BCmIgC;EDlIhC,0BCkI4C;EAC5C,OAAA;AAmKF;;AAhKA;EACE,aAAA;AAmKF;;AAhKA;EACE,YAAA;EACA,0BAAA;EACA,kBAAA;EACA,uBAAA;EACA,0CAAA;EACA,YAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,iBAAA;AAmKF;AAlKI;EACA,SAAA;EACA,eAAA;AAoKJ;AAlKI;EACA,gBAAA;AAoKJ;;AAhKA;EDjKE,aAAA;EACA,mBCiKwB;EDhKxB,yBCgK6B;ED/J7B,mBC+JuC;EACvC,YAAA;EACA,kBAAA;EACA,kBAAA;AAsKF;AArKE;EACE,iBAAA;AAuKJ;AArKE;EACE,eAAA;AAuKJ;;AAnKA;ED9KE,aAAA;EACA,sBC8KwB;ED7KxB,8BC6KgC;ED5KhC,mBC4K+C;EAC/C,uBAAA;EACA,YAAA;EACA,aAAA;EACA,iBAAA;EACA,eAAA;EACA,UAAA;EACA,2CAAA;EACA,YAAA;EACA,kBAAA;AAyKF;AAxKI;EACA,cAAA;EACA,yBAAA;EACA,0BAAA;EACA,YAAA;EACA,mBAAA;AA0KJ;AAxKI;EACA,eAAA;EACA,iBAAA;EACA,YAAA;AA0KJ;AAxKI;EACD,eAAA;EACA,mBAAA;AA0KH;AAxKE;EACC,wCAAA;EACA,iBAAA;EACA,YAAA;EACA,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,4BAAA;AA0KH;AAxKE;EACC,yBAAA;AA0KH;AAxKE;EACC,gBAAA;EACA,kBAAA;EACA,eAAA;AA0KH;;AAtKA;EACE,aAAA;EACA,iBAAA;AAyKF;;AAtKA;EACE,aAAA;AAyKF","sourcesContent":["@use \"_mixins.scss\" as mixins;\n\n.card-deck {\n  @include mixins.flexbox(row, center, center,);\n}\n\n.card-header {\n  @include mixins.flexbox(row, space-between, space-between,);\n}\n\n.card {\n  text-align: center;\n  @include mixins.flexbox(column, flex-start, center,);\n  background-color: white;\n  height: 200px;\n  width: 200px;\n  border-radius: 20px;\n  margin: 0 15px;\n  box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);\n  position: relative;\n    p {\n    margin-bottom: 0;\n  }\n}\n\n.large {\n  width: 430px;\n}\n\n.card-title {\n  text-align: center;\n}\n\n.card-content {\n  width: inherit;\n  @include mixins.flexbox(row, space-between, center,);\n  margin-top: 15px;\n}\n\n.card-content-left {\n  width: 215px;\n    i {\n    padding-top: 5px;\n    color: #f3621d;\n  }\n    p {\n    margin-top: 10px;\n  }\n}\n\n.card-divider {\n  width: 0;\n  height: 130px;\n  border-right: solid 2px lightgray;\n  position: absolute;\n  margin-top: 50px;\n}\n\n.card-content-right {\n  width: 215px;\n  text-align: center;\n  @include mixins.flexbox(column, space-around, center,);\n    span {\n    margin-top: 10px;\n    margin-bottom: 10px;\n      i {\n      margin-right: 5px;\n    }\n  }\n}\n\n.card-goals {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  height: 130px;\n  margin-left: 20px;\n  margin-right: 40px;\n    span b {\n   font-size: large;\n }\n}\n\n.chart-box-large {\n  height: 140px;\n  width: 400px;\n  padding-left: 10px;\n  padding-right: 10px;\n}\n\n.chart-box-small {\n  height: 140px;\n  width: 150px;\n  padding-top: 10px;\n}\n","\n@mixin flexbox($direction, $justify, $align) {\n  display: flex;\n  flex-direction: $direction;\n  justify-content: $justify;\n  align-items: $align;\n}\n","@use \"_mixins.scss\" as mixins;\n@use \"_cards.scss\";\n@use \"_userProfile.scss\";\n\nbody,\nhtml {\n  font-family: 'Roboto', sans-serif;\n  color: #333333;\n  display: flex;\n  height: 100%;\n  width: 100%;\n  margin: 0;\n}\n\nmain {\n  width: 100%;\n  @include mixins.flexbox(column, flex-start, space-between,);\n  height: auto;\n  overflow: hidden;\n}\n\nnav {\n  @include mixins.flexbox(row, space-between, center);\n  padding-left: 60px;\n  padding-right: 60px;\n  background-color: #f5f6fa;\n  height: 100px;\n    p {\n      margin: 0;\n    }\n}\n\nbutton {\n  cursor: pointer;\n}\n\nh2,\np {\n  text-align: center;\n}\n\np {\n  margin-bottom: 0;\n}\n\nh4 {\n  font-size: large;\n  margin-top: 35px;\n  margin-bottom: 35px;\n  margin-left: 60px;\n  color: white;\n}\n\n.dropdown-content {\n  margin-left: 16px;\n  text-align: center;\n  background-color:rgba(255, 255, 255, 0.2);\n  width: inherit;\n  position: fixed;\n  border-radius: 4px;\n  z-index: 1;\n  padding-left: 10px;\n  padding-right: 10px;\n    button {\n      background: none;\n      border: none;\n      color: white;\n      font-weight: bold;\n      padding: 5px;\n  }\n}\n\n.dropdown-divider {\n  border-right: solid 2px white;\n}\n\n.activity-dropdown {\n  padding-left: 10px;\n}\n\n.nav-day-date {\n  border: solid 1px black;\n  padding: 10px 15px;\n  border-radius: 30px;\n    h3 {\n    display: inline;\n  }\n    p {\n    display: inline;\n    margin-left: 10px;\n  }\n}\n\n.logo-box {\n  @include mixins.flexbox(row, center, center);\n  height: 100px;\n}\n\n.logo-png {\n  height: 45px;\n}\n\n.main-sections {\n  display: flex;\n  flex: 1;\n  color: black;\n  overflow: hidden;\n}\n\n.grid-container {\n  @include mixins.flexbox(column, center, center);\n  grid-gap: 30px;\n}\n\n.activity {\n  width: 48%;\n  background-color: #CA2929;\n  padding-bottom: 40px;\n  overflow: scroll;\n}\n\n.hydration-sleep {\n  width: 28%;\n  @include mixins.flexbox(column, flex-start, space-between,);\n  flex: 1;\n}\n\n.hydration {\n  background-color: #2e7ba6;\n  @include mixins.flexbox(column, flex-start, space-between,);\n  flex: 1;\n}\n\n.sleep {\n  background-color: #462c61;\n  @include mixins.flexbox(column, flex-start, space-between,);\n  flex: 1;\n}\n\n.section-title-with-dropdown {\n  display: flex;\n}\n\n.date-toggle {\n  border: none;\n  padding: 9px 15px 8px 15px;\n  border-radius: 5px;\n  background-color: white;\n  background-color: rgba(255, 255, 255, 0.4);\n  color: white;\n  font-size: 16px;\n  margin-top: 28px;\n  margin-left: 15px;\n  align-self: start;\n    p {\n    margin: 0;\n    cursor: pointer;\n  }\n    i {\n    margin-left: 5px;\n  }\n}\n\n.add-data {\n  @include mixins.flexbox(row, flex-end, center);\n  color: white;\n  margin-right: 60px;\n  position: relative;\n  i {\n    margin-right: 5px;\n  }\n  span {\n    cursor: pointer;\n  }\n}\n\n.add-data-form {\n  @include mixins.flexbox(column, space-between, center);\n  background-color: white;\n  width: 250px;\n  height: 350px;\n  margin-top: 330px;\n  position: fixed;\n  z-index: 1;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  color: black;\n  border-radius: 5px;\n    input {\n    display: block;\n    background-color: #f1f1f1;\n    border: solid 1px darkgray;\n    height: 20px;\n    margin-bottom: 10px;\n  }\n    label {\n    font-size: 14px;\n    font-weight: bold;\n    color:black;\n  }\n    p {\n   margin-top: 0px;\n   margin-bottom: 10px;\n }\n  button {\n   background-color: rgba(4, 170, 109, 0.8);\n   font-weight: bold;\n   color: white;\n   margin-bottom: 30px;\n   border: none;\n   border-radius: 3px;\n   padding: 10px 20px 10px 20px;\n }\n  button:hover {\n   background-color: rgba(4, 170, 109, 1);\n }\n  i {\n   margin-top: 15px;\n   margin-left: 205px;\n   cursor: pointer;\n }\n}\n\n.small-form {\n  height: 280px;\n  margin-top: 260px;\n}\n\n.hidden {\n  display: none;\n}\n","@use \"_mixins.scss\" as mixins;\n\naside {\n  @include mixins.flexbox(column, flex-start, center);\n  width: 370px;\n  overflow: hidden;\n    h2 {\n    margin-bottom: 15px;\n  }\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n}\n\n.profile-pic {\n  height: 300px;\n}\n\n.info-section {\n  @include mixins.flexbox(row, space-between, flex-start);\n}\n\ntable {\n  margin-left: 12px;\n  padding-right: 20px;\n}\n\n.contact-info {\n  display: flex;\n  flex-wrap: wrap;\n  overflow-wrap: normal;\n  margin: 4%;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
...
let domUpdates = {
  ...
  chartSleepToday(sleepRepository, userId) {
    ...
    this.sleepTodayChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](chartSleepHoursToday,
      {
        type: 'bar',
        data: {
  ...
  chartLatestWeekOfSleepStats(sleepRepository, userId) {
    ...
    this.sleepLatestWeekChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](chartSleepHoursForLatestWeek,
      {
        type: 'bar',
        data: {
  ...
  chartAllTimeUserSleepStats(sleepRepository, userId) {
    ...
    this.sleepAllTimeChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](chartAllTimeSleepStats,
      {
        type: 'bar',
        data: {
  ...
  chartHydrationToday(userHydrationData) {
    ...
    this.hydrationTodayChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](chart,
      {
        type: 'bar',
        data: {
          labels: [latestDayDate],
  ...
  chartHydrationLatestWeek(userHydrationData) {
    ...
    this.chartHydrationWeek = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](chartHydrationForLatestWeek,
      {
        type: 'bar',
        data: {
  ...
  chartActivityTypeForLatestWeek(activityType, label, querySelector, userActivities) {
    ...
    this.activityCharts[activityType] = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](querySelector,
      {
        type: 'bar',
        data: {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _dist_chart_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/*!
 * Chart.js v3.6.0
...
/* harmony export */   "postNewSleepEvent": () => (/* binding */ postNewSleepEvent),
/* harmony export */   "postNewActivityEvent": () => (/* binding */ postNewActivityEvent),
/* harmony export */   "postNewHydrationEvent": () => (/* binding */ postNewHydrationEvent)
/* harmony export */ });
let fetchUserData = () => {
...
let postNewSleepEvent = (newSleepEvent) => {
...
let postNewActivityEvent = (newActivityEvent) => {
...
let postNewHydrationEvent = (newHydrationEvent) => {
...
/* harmony import */ var _UserRepository__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
/* harmony import */ var _SleepRepository__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14);
/* harmony import */ var _HydrationRepository__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(15);
/* harmony import */ var _Hydration__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16);
/* harmony import */ var _Activity__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(17);
/* harmony import */ var _ActivityRepository__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(18);
...
const fetchAll = () => {
  const userDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchUserData)();
  const sleepDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchSleepData)();
  const hydrationDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchHydrationData)();
  const activityDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchActivityData)();
  Promise.all([userDataPromise, sleepDataPromise, hydrationDataPromise, activityDataPromise])
    .then(data => {
      ...
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserInfo(user, sleepRepository, userId, userRepository);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserSleepInfo(sleepRepository, userId);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserHydrationInfo(hydrationRepository, userHydrationData);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserActivityInfo(activityRepository, userActivities);
    })
...
const parseAllData = (data) => {
  userRepository = new _UserRepository__WEBPACK_IMPORTED_MODULE_4__["default"](data.userData);
  user = new _User__WEBPACK_IMPORTED_MODULE_5__["default"](userRepository.renderUserData(userId));
}

const parseSleepData = (sleepData) => {
  sleepRepository = new _SleepRepository__WEBPACK_IMPORTED_MODULE_6__["default"](sleepData.sleepData);
}

const parseHydrationData = (hydrationData) => {
  hydrationRepository = new _HydrationRepository__WEBPACK_IMPORTED_MODULE_7__["default"](hydrationData.hydrationData);
  userHydrationData = new _Hydration__WEBPACK_IMPORTED_MODULE_8__["default"](hydrationRepository.renderUserData(userId));
}

const parseActivityData = (activityData) => {
  activityRepository = new _ActivityRepository__WEBPACK_IMPORTED_MODULE_10__["default"](activityData.activityData);
  userActivities = new _Activity__WEBPACK_IMPORTED_MODULE_9__["default"](activityRepository.getUserActivity(userId), user.strideLength, user.dailyStepGoal);
}
...
const addSleepData = () => {
  ...
  return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.postNewSleepEvent)(newSleepEvent)
...
const addActivityData = () => {
  ...
  return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.postNewActivityEvent)(newActivityEvent)
    .then(data => {
...
const addHydrationData = () => {
  ...
  return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.postNewHydrationEvent)(newHydrationEvent)
    .then(data => {
...
sleepSubmitButton.addEventListener('click', (event) => {
  ...
  addSleepData()
    .then(() => {
      return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchSleepData)();
    })
    .then(data => {
      parseSleepData(data);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserSleepInfo(sleepRepository, userId);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].hideSleepDataForm();
    })
});
...
activitySubmitButton.addEventListener('click', (event) => {
  ...
  addActivityData()
    .then(() => {
      return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchActivityData)();
    })
    .then(data => {
      parseActivityData(data);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserActivityInfo(activityRepository, userActivities);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].hideActivityDataForm();
    })
});
...
hydrationSubmitButton.addEventListener('click', (event) => {
  ...
  addHydrationData()
    .then(() => {
      return (0,_apiCalls__WEBPACK_IMPORTED_MODULE_3__.fetchHydrationData)();
    })
    .then(data => {
      parseHydrationData(data);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].displayUserHydrationInfo(hydrationRepository, userHydrationData);
      _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].hideHydrationDataForm();
    })
})
