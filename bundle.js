...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* body, html {\n  background-image: linear-gradient(to top, #ff9a9e 0%, #fecfef 99%, #fecfef 100%);\n  background-repeat: no-repeat;\n  height: 100%;\n} */\nhtml, body {\n  font-family: 'Roboto', sans-serif;\n  display: flex;\n  height: 100%;\n  width: 100%;\n  margin: 0;\n}\n\nmain {\n  width: 100%;\n  display:flex;\n  flex-direction: column;\n  height: auto;\n  overflow: hidden;\n}\n\nnav {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 60px;\n  padding-right: 60px;\n  background-color: #f5f6fa;\n  height: 100px;\n}\n\nbutton {\n  cursor: pointer;\n}\n\np, h2 {\n  text-align: center;\n}\n\n.dropdown-content {\n  display: block;\n  margin-left: 16px;\n  text-align: center;\n  background-color: LightGray;\n  width: 85px;\n  position: fixed;\n  z-index: 1;\n}\n\n.nav-day-date {\n  border: solid 2px black;\n  padding: 10px 15px 10px 15px;\n  border-radius: 30px;\n}\n\n.nav-date {\n  display: inline;\n}\n\n.nav-day {\n  display:inline;\n}\n\naside {\n  width: 370px;\n  overflow: hidden;\n}\n\n.logo {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height:100px;\n}\n\n.profile-pic {\n  height: 300px;\n  background-color: LightGray;\n}\n\n.info-section {\n  display: flex;\n  justify-content: space-between;\n}\n\n.contact-info {\n  display: flex;\n  flex-wrap: wrap;\n  overflow-wrap: normal;\n  margin: 4%;\n}\n\np{\n  margin-bottom: 0;\n\n}\nh4 {\n  margin-top: 35px;\n  margin-left: 60px;\n  color: white;\n}\n\n.main-sections {\n  display: flex;\n  flex: 1;\n  color: black;\n  overflow: hidden;\n}\n\n.activity {\n  width: 48%;\n  background-color: #fd7326;\n}\n\n.activity-cards-second-row {\n  display: flex;\n}\n\n.card {\n  text-align: center;\n  background-color: white;\n  height: 200px;\n  width: 200px;\n  border-radius: 20px;\n  margin: 0px 15px 0px 15px;\n}\n\n.large {\n  width: 430px;\n}\n\n.card-title{\n  text-align: center;\n}\n\n.chart-box-large {\n  height: 140px;\n  width: 400px;\n  padding-left: 10px;\n}\n\n.chart-box-small {\n  height: 140px;\n  width: 150px;\n  padding-left: 20px;\n}\n\n.grid-container {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: center;\n  grid-template-columns: 2;\n  grid-auto-rows: 2;\n  grid-gap: 30px;\n}\n\n.hydration-sleep {\n  width: 28%;\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n}\n\n.hydration{\n  background-color: #2e7ba6;\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n}\n\n.card-deck {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.card-header {\n  display: flex;\n}\n\n.date-toggle {\n  border: solid 2px white;\n  padding: 10px 20px 10px 20px;\n  border-radius: 30px;\n  background-color: inherit;\n  color: white;\n  font-size: 16px;\n  margin-top: 23px;\n  margin-left: 15px;\n  align-self: start;\n}\n\n.date-toggle p {\n  margin: 0;\n}\n\n.sleep {\n  background-color: #462c61;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  flex: 1;\n}\n\n.sleep-cards-first-row {\n  display: flex;\n}\n\n.friends {\n  background-color: #ECEDF2;\n  width: 24%;\n}\n\n.hidden {\n  display:none;\n}\n", "",{"version":3,"sources":["webpack://./src/css/styles.css"],"names":[],"mappings":"AAAA;;;;GAIG;AACH;EACE,iCAAiC;EACjC,aAAa;EACb,YAAY;EACZ,WAAW;EACX,SAAS;AACX;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,sBAAsB;EACtB,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;EACnB,yBAAyB;EACzB,aAAa;AACf;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,iBAAiB;EACjB,kBAAkB;EAClB,2BAA2B;EAC3B,WAAW;EACX,eAAe;EACf,UAAU;AACZ;;AAEA;EACE,uBAAuB;EACvB,4BAA4B;EAC5B,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,eAAe;EACf,qBAAqB;EACrB,UAAU;AACZ;;AAEA;EACE,gBAAgB;;AAElB;AACA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,OAAO;EACP,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,UAAU;EACV,yBAAyB;AAC3B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,uBAAuB;EACvB,aAAa;EACb,YAAY;EACZ,mBAAmB;EACnB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,mBAAmB;EACnB,uBAAuB;EACvB,wBAAwB;EACxB,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,UAAU;EACV,aAAa;EACb,sBAAsB;EACtB,OAAO;AACT;;AAEA;EACE,yBAAyB;EACzB,OAAO;EACP,aAAa;EACb,sBAAsB;EACtB,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,uBAAuB;EACvB,4BAA4B;EAC5B,mBAAmB;EACnB,yBAAyB;EACzB,YAAY;EACZ,eAAe;EACf,gBAAgB;EAChB,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,yBAAyB;EACzB,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,OAAO;AACT;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,yBAAyB;EACzB,UAAU;AACZ;;AAEA;EACE,YAAY;AACd","sourcesContent":["/* body, html {\n  background-image: linear-gradient(to top, #ff9a9e 0%, #fecfef 99%, #fecfef 100%);\n  background-repeat: no-repeat;\n  height: 100%;\n} */\nhtml, body {\n  font-family: 'Roboto', sans-serif;\n  display: flex;\n  height: 100%;\n  width: 100%;\n  margin: 0;\n}\n\nmain {\n  width: 100%;\n  display:flex;\n  flex-direction: column;\n  height: auto;\n  overflow: hidden;\n}\n\nnav {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 60px;\n  padding-right: 60px;\n  background-color: #f5f6fa;\n  height: 100px;\n}\n\nbutton {\n  cursor: pointer;\n}\n\np, h2 {\n  text-align: center;\n}\n\n.dropdown-content {\n  display: block;\n  margin-left: 16px;\n  text-align: center;\n  background-color: LightGray;\n  width: 85px;\n  position: fixed;\n  z-index: 1;\n}\n\n.nav-day-date {\n  border: solid 2px black;\n  padding: 10px 15px 10px 15px;\n  border-radius: 30px;\n}\n\n.nav-date {\n  display: inline;\n}\n\n.nav-day {\n  display:inline;\n}\n\naside {\n  width: 370px;\n  overflow: hidden;\n}\n\n.logo {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height:100px;\n}\n\n.profile-pic {\n  height: 300px;\n  background-color: LightGray;\n}\n\n.info-section {\n  display: flex;\n  justify-content: space-between;\n}\n\n.contact-info {\n  display: flex;\n  flex-wrap: wrap;\n  overflow-wrap: normal;\n  margin: 4%;\n}\n\np{\n  margin-bottom: 0;\n\n}\nh4 {\n  margin-top: 35px;\n  margin-left: 60px;\n  color: white;\n}\n\n.main-sections {\n  display: flex;\n  flex: 1;\n  color: black;\n  overflow: hidden;\n}\n\n.activity {\n  width: 48%;\n  background-color: #fd7326;\n}\n\n.activity-cards-second-row {\n  display: flex;\n}\n\n.card {\n  text-align: center;\n  background-color: white;\n  height: 200px;\n  width: 200px;\n  border-radius: 20px;\n  margin: 0px 15px 0px 15px;\n}\n\n.large {\n  width: 430px;\n}\n\n.card-title{\n  text-align: center;\n}\n\n.chart-box-large {\n  height: 140px;\n  width: 400px;\n  padding-left: 10px;\n}\n\n.chart-box-small {\n  height: 140px;\n  width: 150px;\n  padding-left: 20px;\n}\n\n.grid-container {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: center;\n  grid-template-columns: 2;\n  grid-auto-rows: 2;\n  grid-gap: 30px;\n}\n\n.hydration-sleep {\n  width: 28%;\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n}\n\n.hydration{\n  background-color: #2e7ba6;\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n}\n\n.card-deck {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.card-header {\n  display: flex;\n}\n\n.date-toggle {\n  border: solid 2px white;\n  padding: 10px 20px 10px 20px;\n  border-radius: 30px;\n  background-color: inherit;\n  color: white;\n  font-size: 16px;\n  margin-top: 23px;\n  margin-left: 15px;\n  align-self: start;\n}\n\n.date-toggle p {\n  margin: 0;\n}\n\n.sleep {\n  background-color: #462c61;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  flex: 1;\n}\n\n.sleep-cards-first-row {\n  display: flex;\n}\n\n.friends {\n  background-color: #ECEDF2;\n  width: 24%;\n}\n\n.hidden {\n  display:none;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _dist_chart_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
/* harmony import */ var _SleepRepository__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _HydrationRepository__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11);
/* harmony import */ var _Hydration__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(12);
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(13);
...
const fetchAll = () => {
  const userDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.fetchUserData)();
  const sleepDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.fetchSleepData)();
  const hydrationDataPromise = (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.fetchHydrationData)();
...
const parseAllData = (data) => {
  userRepository = new _UserRepository__WEBPACK_IMPORTED_MODULE_3__.default(data.userData);
  user = new _User__WEBPACK_IMPORTED_MODULE_4__.default(userRepository.renderUserData(userId));
}

const parseSleepData = (sleepData) => {
  sleepRepository = new _SleepRepository__WEBPACK_IMPORTED_MODULE_5__.default(sleepData.sleepData);
}

const parseHydrationData = (hydrationData) => {
  hydrationRepository = new _HydrationRepository__WEBPACK_IMPORTED_MODULE_6__.default(hydrationData.hydrationData);
  userHydrationData = new _Hydration__WEBPACK_IMPORTED_MODULE_7__.default(hydrationRepository.renderUserData(userId));
}
...
const chartSleepToday = () => {
  ...
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_8__.default(chartSleepHoursToday, 
    {
      type: 'bar',
      data: {
...
const chartLatestWeekOfSleepStats = () => { 
  ...
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_8__.default(chartSleepHoursForLatestWeek, 
    {
      type: 'bar',
      data: {
...
const chartAllTimeUserSleepStats = () => {
  ...
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_8__.default(chartAllTimeSleepStats,
    {
      type: 'bar',
      data: {
...
const chartHydrationLatestWeek = () => {
  ...
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_8__.default(chartHydrationForLatestWeek,   
    {
      type: 'bar',
      data: {
